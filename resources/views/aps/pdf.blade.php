...
<head>
    ...
    height: 200px;
    width: 100%;
    background-image: url( '{{ asset("/assets/img/header_vf.png") }} ');
    ...
    position: relative;
    top: -160px;
    background-image: url( '{{ asset("/assets/img/emblème_vf.png") }}');
...
.foot {
    height: 250px;
    background-image: url( '{{ asset("/assets/img/footer.png") }}');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;
    ...
    <div class="page page-1">
        ...
        <div class="document-content">
            <table>
                <tr>
                    ...
                    <td style="width: 45%; vertical-align: top; text-align: center;">
                        ...
                        À<br><br>
                        <strong>{{ $ap->nom_proprietaire }}</strong>
                    </td>
                </tr>
            </table>

            <div class="document-title text-center">
                Avis de Paiement n°<u>{{ $ap->id }}</u>/2025
            </div>
            ...
            <div class="content-block1">
                ...
                <p>Vu le certificat de situation juridique de la propriété dite {{ $ap->imm }} sise à {{ $ap->comm_propriete }} en date du 08/10/2024 ;</p>
    ...
    <div class="page page-2">
        <div class="document-content">
            ...
            <div class="content-block2">
                ...
                <p><strong><u>Titre N°:</u></strong> {{ $ap->titre }}</p>
                
                <p><strong><u>Coordonnées :</u></strong></p>
                <p>X = {{ $ap->x }}</p>
                <p>Y = {{ $ap->y }}</p>
                
                <p><strong><u>Localisation :</u></strong> {{ $ap->fkt }}</p>
            </div>
