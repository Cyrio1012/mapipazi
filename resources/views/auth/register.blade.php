...
<head>
  ...
  <title>Inscription - APIPA Antananarivo</title>
        ...
        <div class="form-wrapper">
          ...
          <div class="form-content">
            <div class="form-header">
                ...
                <p class="mt-5">Créez votre compte pour commencer</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" required autofocus autocomplete="name" value="{{ old('name') }}" placeholder="Votre nom complet">
                </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="email" id="email" name="email" class="form-control" required autocomplete="username" value="{{ old('email') }}" placeholder="votre@email.com">
                </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="password" id="password" name="password" class="form-control" required autocomplete="new-password" placeholder="Votre mot de passe">
                </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  <i class="fas fa-lock input-icon"></i>
                  <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" required autocomplete="new-password" placeholder="Confirmer le mot de passe">
                </div>
